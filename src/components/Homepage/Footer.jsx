      ...
      <div class='mx-auto max-w-7xl'>
        <div class='grid grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-12 pt-12 pb-4 max-w-md mx-auto md:max-w-xl lg:max-w-full'>
          <div class='block'>
            <ul class='text-lg transition-all duration-500'>
              <li class='mb-6 text-lg text-white font-bold'>
                <a href='/' class=' text-gray-400 hover:text-white'>
                  Our programs
                </a>
              </li>
              <li class='mb-6 text-sm text-white font-semibold'>
        ...
        <div class='flex items-center justify-center flex-col lg:space-y-0 space-y-8 lg:justify-between lg:flex-row'>
          ...
          <div className='flex items-center justify-center sm:gap-2 md:gap:6 xl:gap-12'>
            ...
            <button
              type='button'
              class='flex items-center justify-center w-[10rem] mt-3 text-white bg-black rounded-lg h-[3.2rem] border border-white'
            >
              <div class='mr-1'>
              ...
              <div>
                ...
                <div class='-mt-0 font-sans text-lg font-semibold'>
                  Google Play
                </div>
              </div>
            </button>
      ...
      <div className=' py-6'>
        <nav className='text-white flex items-center justify-center gap-8'>
          ...
          <span class='text-gray-400  block'>
            ©<a href='https://pagedone.io/'>Sublimauto</a> 2024
          </span>
        </nav>
      </div>
    </footer>
