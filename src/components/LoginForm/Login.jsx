          ...
          <div className='fixed inset-0 z-50 outline-none focus:outline-none '>
            <div className='min-h-screen bg-transparent text-gray-900 flex justify-center items-center'>
              <div className='max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1 relative transform transition-transform duration-300 ease-out scale-0 opacity-0 modal-transition'>
                  ...
                  <div className='-mt-10 flex flex-col items-center'>
                    <div className='w-full flex-1 mt-8'>
                      ...
                      <div className='mx-auto max-w-xs'>
                        ...
                        />
                        <button className='mt-5 tracking-wide font-semibold bg-orange-400 text-white-500 w-full py-4 rounded-lg hover:bg-orange-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none'>
                          <svg
                        ...
                        <p className='mt-6 text-xs text-gray-600 text-center'>
                          I agree to abide by Sublimauto
                          <a
                            href='/'
                ...
                <div className='flex-1 bg-orange-100 text-center hidden lg:flex sm:rounded-lg'>
                  <div className='w-full bg-login bg-cover bg-center bg-no-repeat sm:rounded-r-lg '></div>
                </div>
              </div>
            </div>
          </div>
